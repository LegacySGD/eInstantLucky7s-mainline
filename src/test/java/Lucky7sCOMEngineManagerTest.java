...
public class Lucky7sCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Lucky7sCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Lucky7sIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Lucky7sIW/InitOutcome.xml").getDocumentElement();
